...
num_reg=472
seq_length=1000
fig_dir='../figures/gru/concat.pool.491/'
log_dir='../logs/gru/concat.pool.491/'
out_dir='../processed_data/gru/concat.pool.491/'
...
x=MaxPooling2D(pool_size=(1,491),border_mode='same')(x)
x=Activation('relu')(x)
