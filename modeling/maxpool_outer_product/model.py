...
num_reg=472
seq_length=1000
fig_dir='../figures/maxpool_outer_product/'
log_dir='../logs/maxpool_outer_product/'
out_dir='../processed_data/maxpool_outer_product/'
...
history=model.fit({'seq_input':train['seq'],'reg_input':train['reg']},{'rgs_output':train['expr']},validation_data=({'seq_input':val['seq'],'reg_input':val['reg']},{'rgs_output':val['expr']}),nb_epoch=1,batch_size=100,callbacks=[early_stopping,checkpoint],verbose=1)
