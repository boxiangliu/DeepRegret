...
import numpy as np
import sys,os
sys.path.append('/srv/scratch/bliu2/deepregret/scripts/modeling/keras1/')
import input_data
...
num_reg=472
seq_length=1000
fig_dir='../figures/keras1/'
log_dir='../logs/keras1/'
out_dir='../processed_data/keras1/'
...
x=Convolution2D(nb_filter=filters[0],nb_row=4,nb_col=kernel_width[0],subsample=(4,4),border_mode='valid')(seq_input)
x=Convolution2D(nb_filter=filters[1],nb_row=1,nb_col=kernel_width[1],subsample=(4,4),border_mode='valid')(x)
...
print('rmsprop')
model.compile(loss={'rgs_output':'mean_squared_error'},optimizer='rmsprop')
