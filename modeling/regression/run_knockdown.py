...
def run_training():
	...
	data_sets = knockdown_data.read_data_sets(seq_file=FLAGS.seq_file,expr_file=FLAGS.expr_file,reg_names_file=FLAGS.reg_names_file,fold_change=FLAGS.fold_change)
	...
	with tf.Graph().as_default():
		...
		pred=prediction(sess,y,seq_placeholder,reg_expr_placeholder,labels_placeholder,keep_prob_placeholder,meta_placeholder,data_sets.knockdown_data)
...
if __name__ == '__main__':
	...
	parser.add_argument('--fold_change',type=float,default=0.0,help='Fold change in expression level in the knockdown gene.')
