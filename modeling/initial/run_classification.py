...
def placeholder_inputs(batch_size):
	...
	return seq_placeholder, reg_expr_placeholder, labels_placeholder

def fill_feed_dict(data_set, seq_pl, reg_expr_pl, labels_pl):
	...
	feed_dict = {seq_pl: seq_feed,reg_expr_pl: reg_expr_feed,labels_pl: labels_feed}
	return feed_dict


def do_eval(sess,eval_correct,seq_placeholder,reg_expr_placeholder,labels_placeholder,data_set):
	...
	for step in xrange(steps_per_epoch):
		feed_dict = fill_feed_dict(data_set,seq_placeholder,reg_expr_placeholder,labels_placeholder)
