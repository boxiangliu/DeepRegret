...
num_reg=472
seq_length=1000
dir_suffix='/concatenation/regression_experiment-hold-out/'
...
x=Activation('relu')(x)
x=MaxPooling2D(pool_size=(1,16),strides=(1,14),border_mode='valid')(x)
...
train,val,test=input_data.read_data_sets(train_pct=80,val_pct=10,test_pct=10,mode='whole_experiment')
